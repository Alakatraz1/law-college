...
<!-- Mirrored from html.themexriver.com/lasight/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 11:35:21 GMT -->

<head>
	<meta charset="utf-8">
	<meta name="description" content="Law Lawyer Law Office - Law  HTML Template">
	<meta name="keywords"
		content="advocate, attorney, attorney website, attorneys, barrister, business, corporate, law, law firm, law office, lawyer, lawyer theme, legal blog, legal services, notary">
...
<body>
	...
	<div class="page-wrapper">
		...
		<section class="banner-section">
			<div class="main-slider-carousel owl-carousel owl-theme">
				...
				<div class="slide" style="background-image:url(images/main-slider/1.jpg)">
					<div class="container">
						<div class="content">
							<div class="title">Building Legal Minds, Shaping Futures</div>
							<h1>Welcome To DMS Shikshan Prashikshan<br> <span>Law College</span></h1>
							<a href="#" class="theme-btn btn-style-one">Admission</a>
					...
					<div class="services-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
							...
							<div class="content">
								...
								<h6><a href="services-detail.html">About Campus</a></h6>
								<div class="text">Lorem ipsum dolor sit amet, con sectetu adipiscing elit, sed do eius
									mod tempor.</div>
							</div>
						</div>
					</div>
					...
					<div class="services-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
							...
							<div class="content">
								...
								<h6><a href="services-detail.html">Scholarship Facility</a></h6>
								<div class="text">Lorem ipsum dolor sit amet, con sectetu adipiscing elit, sed do eius
									mod tempor.</div>
							</div>
						</div>
					...
					<div class="services-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
							...
							<div class="content">
								...
								<h6><a href="services-detail.html">About Admission</a></h6>
								<div class="text">Lorem ipsum dolor sit amet, con sectetu adipiscing elit, sed do eius
									mod tempor.</div>
							</div>
						</div>
					...
					<div class="content-column col-lg-7 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="section-title">
								...
								<h3>We are here to build a future where justice and integrity <span>lead the way.</span>
								</h3>
							</div>

							<div class="text">
								<p>The commitment to fostering exceptional legal minds goes like this: If you create an
									environment rich in knowledge and ethics, you’ll shape leaders who uphold justice in
									society.</p>

									<p>Our programs are designed to empower students with practical skills and theoretical
									understanding, ensuring they excel in the legal field.</p>
							...
							<div class="row clearfix">
								<div class="column col-lg-6 col-md-6 col-sm-12">
									<ul class="list-style-one">
										<li>Discover endless opportunities.</li>
									</ul>
								</div>
								<div class="column col-lg-6 col-md-6 col-sm-12">
									<ul class="list-style-one">
										<li>A brighter tomorrow starts today.</li>
									</ul>
								</div>
								<div class="column col-lg-6 col-md-6 col-sm-12">
									<ul class="list-style-one">
										<li>Make a difference in law and society.</li>
									</ul>
								</div>
								<div class="column col-lg-6 col-md-6 col-sm-12">
									<ul class="list-style-one">
										<li>Shape your future with us.</li>
									</ul>
								</div>
							</div>
							<div class="question">Call to ask <a href="#">any question</a> <strong>+91-9305831808</strong>
								
							</div>
							<div class="signature">
								<div class="signature-img"><img src="images/icons/signature.png" alt="" /></div>
								<h5>Om Narayan Singh (IAS)</h5>
				...
				<div class="row clearfix">
					...
					<div class="services-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							...
							<h3>Business Law</h3>
							<div class="text">It is a long established fact that areader will be distracted by the
								readable content of a page when looking.</div>
								...
								<div class="testimonial-block">
									<div class="inner-box">
										<div class="testimonial-content">
											...
											<div class="text">Aenean tincidunt id mauris id auctor. Donec at ligula
												lacus. Nulla dignissim mi quis neque interdum, quis porta sem finibus.
												Them to gho ifndtp, no.</div>
											<!-- Lower Box -->
											<div class="lower-box">
												<div class="box-inner">
													<div class="image">
		...
		<section class="counter-section">
			...
			<div class="icon-two wow slideInRight" data-wow-delay="500ms" data-wow-duration="1500ms"
				style="background-image:url(images/icons/icon-4.png)"></div>
			<div class="container">
				<!-- Title Box -->
				<div class="title-box">
					<div class="section-title">
				...
				<div class="section-title light">
					<div class="clearfix">
						...
						<div class="pull-right">
							<div class="text">Aenean tincidunt id mauris idology auctor. Donec at ligula lacus. Nulla
								dig nissimmi quis neque interdum. An Ohio man allegedly punched his lawyer in the face
								in court Tuesday upon finding out he was sentenced.</div>
						</div>
					</div>
				</div>
								...
								<div class="row clearfix">
									...
									<div class="column col-lg-6 col-md-6 col-sm-12">
										<ul class="list-style-two">
											<li><span class="icon flaticon-placeholder-1"></span>Karma Devi Group of Educational Institutions Sansarpur Phutahiya, Basti 272001</li>
										</ul>
									</div>
									<!-- Column -->
									<div class="column col-lg-6 col-md-6 col-sm-12">
										<ul class="list-style-two">
											<li><span class="icon flaticon-phone-call"></span>+91-9305831808</li>
											<li><span class="icon flaticon-chat"></span>dms.law@karmadevigroup.com</li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="news-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								...
								<div class="overlay-box">
									<a href="images/resource/news-1.jpg" data-fancybox="news" data-caption=""
										class="plus flaticon-plus"></a>
								</div>
							</div>
							<div class="lower-content">
					...
					<div class="news-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
							<div class="image">
								...
								<div class="overlay-box">
									<a href="images/resource/news-2.jpg" data-fancybox="news" data-caption=""
										class="plus flaticon-plus"></a>
								</div>
							</div>
							<div class="lower-content">
					...
					<div class="news-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
							<div class="image">
								...
								<div class="overlay-box">
									<a href="images/resource/news-3.jpg" data-fancybox="news" data-caption=""
										class="plus flaticon-plus"></a>
								</div>
							</div>
							<div class="lower-content">
								...
								<h5><a href="blog-single.html">Food industry leaders often change their promoters.</a>
								</h5>
								<a href="blog-single.html" class="theme-btn btn-style-two">View more</a>
							</div>
						</div>
			...
			<div class="container">
				<div class="inner-container" style="background-image: url(images/background/3.jpg)">
					...
					<div class="subscribe-form">
						<form method="post" action="https://html.themexriver.com/lasight/contact.html">
...
<!-- Mirrored from html.themexriver.com/lasight/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 11:35:40 GMT -->
